      ...
      <div ref={mobileNav}>
        ...
        >
          <ul className="px-5 py-2">
            <li>
              <Link href="/about" className="flex font-medium w-full text-gray-600 hover:text-gray-900 py-2 justify-center" onClick={() => setMobileNavOpen(false)}>Hakkımda</Link>
            </li>
            <li>
              <Link href="/iletisim" className="flex font-medium w-full text-gray-600 hover:text-gray-900 py-2 justify-center" onClick={() => setMobileNavOpen(false)}>İletişim</Link>
            </li>
            
            <li>
              <Link href="/atolye" className="flex font-medium w-full text-gray-600 hover:text-gray-900 py-2 justify-center" onClick={() => setMobileNavOpen(false)}>Atölyeler</Link>
            </li>
            <li>
              <Link href="/#randevuBilgi" className="flex font-medium w-full text-gray-600 hover:text-gray-900 py-2 justify-center" onClick={() => setMobileNavOpen(false)}>Randevu Bilgisi</Link>
            </li>
            <li>
              <Link href="/yazilar" className="btn-sm text-gray-200 bg-gray-900 hover:bg-gray-800 w-full my-2" onClick={() => setMobileNavOpen(false)}>
                <span>Yazılarım</span>
            ...
            <li>
              <Link href="/#randevuRedirect" className="btn-sm text-gray-200 bg-gray-900 hover:bg-gray-800 w-full my-2" onClick={() => setMobileNavOpen(false)}>
              ...
              <li className="ml-4">
                ...
                >
                  <svg
                    ...
                    className="w-8 p-1 h-8 fill-current text-fuchsia-600 hover:text-white"
