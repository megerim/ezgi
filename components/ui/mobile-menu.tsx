      ...
      <div ref={mobileNav}>
        ...
        >
          <ul className="px-5 py-2">
            ...
            <li>
              <Link href="/atolye" className="flex font-medium w-full text-gray-600 hover:text-gray-900 py-2 justify-center" onClick={() => setMobileNavOpen(false)}>Atölye Detayları</Link>
            </li>
            <li>
            ...
            <li>
              <Link href="/atolye/basvuru" className="btn-sm text-gray-200 bg-gray-900 hover:bg-gray-800 w-full my-2" onClick={() => setMobileNavOpen(false)}>
                <span>Atölye Başvuru Formu</span>
